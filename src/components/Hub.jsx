  ...
  return (
    <div className="bg-gray-300 w-full h-screen">
      <div className="flex flex-row h-[100%] justify-center items-center space-x-8">
        <Link to="/login" state={"company"} className="bg-white w-[30%] h-[50%] rounded-md flex flex-col justify-center items-center">
          <div>
            <svg
              viewBox="0 0 24 24"
              fill="currentColor"
        ...
        <Link to="/login" state={"jobseeker"} className="bg-white w-[30%] h-[50%] rounded-md flex flex-col justify-center items-center">
          <div >
            <svg
              fill="currentColor"
              viewBox="0 0 16 16"
